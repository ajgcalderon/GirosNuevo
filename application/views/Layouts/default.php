    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo base_url();?>">Giros Venezuela</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url();?>"><i class="fa fa-dashboard fa-fw"></i> Generales</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Supervisores<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Giradores<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Girador 1</a>
                                </li>
                                <li>
                                    <a href="morris.html">Girador 2</a>
                                </li>
                                <li>
                                    <a href="morris.html">Girador 3</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="Transferencias"><i class="fa fa-table fa-fw"></i>Transferencias</a>
                        </li>
                        <li>
                            <a href="Transferencias/Registro"><i class="fa fa-edit fa-fw"></i> Registro de Transferencias</a>
                        </li>
                        <li>
